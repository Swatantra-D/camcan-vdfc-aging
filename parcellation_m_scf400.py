...
time_series_file_scf = os.path.join(out_dir, "time_series_movie_scf400_all_denoised_{}.npy".format(timestamp))
...
# subject_ids_file = os.path.join(out_dir, "subject_ids_movie_scf400_all_denoised_{}.csv".format(timestamp))
...
if error_files:
	...
	error_file = os.path.join(out_dir, "error_subjects_movie_scf400_all_denoised_{}.csv".format(timestamp))
...
# error_subjects_file = r"C:\Users\SWAT\Documents\data\time_series\error_subjects_movie_scf400_all_denoised_{}.csv".format(timestamp)
