...
time_series_file_hcp = os.path.join(out_dir, "TS_rest_HCP_{}.npy".format(timestamp))
...
subject_ids_file = os.path.join(out_dir, "sub_ids_rest_HCP_{}.csv".format(timestamp))
...
if error_files:
	...
	error_file = os.path.join(out_dir, "error_sub_rest_HCP_{}.csv".format(timestamp))
