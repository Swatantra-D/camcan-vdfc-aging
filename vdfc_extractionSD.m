% Script to generate dFC results for SMT Desikan data
...
input_file = '/scratch/data/p25ai0202/swat/cam_data/time_series/TS_smt_dsk_2026-08-18_17-07-37.mat';
input_data = load(input_file);
time_series_data = input_data.time_series;
clear input_data;
disp('SMT Desikan data loaded successfully.');
...
output_file = fullfile(output_path, ['vDFC_results_SD_W3_107_' num2str(time) '.mat']);
