% Script to generate dFC results for SMT scf400 data
...
input_file = '/scratch/data/p25ai0202/swat/cam_data/time_series/TS_smt_scf400_2026-08-18_20-59-41.mat';
input_data = load(input_file);
time_series_data = input_data.time_series;
clear input_data;
disp('SMT scf400 data loaded successfully.');
...
output_file = fullfile(output_path, ['vDFC_results_SS_W3_107_' num2str(time) '.mat']);
