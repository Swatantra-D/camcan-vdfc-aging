...
# setup nifti masker
masker = NiftiLabelsMasker(labels_img=desikan_atlas, memory=memory, verbose=0)
masker.fit()
...
time_series_file_desikan = os.path.join(out_dir, "TS_smt_dsk_{}.npy".format(timestamp))
...
if error_files:
	...
	error_file = os.path.join(out_dir, "error_subID_rst_dsk_{}.csv".format(timestamp))
