% Script to generate vdFC results for movie Desikan data
...
input_file = '/scratch/data/p25ai0202/swat/cam_data/time_series/TS_movie_dsk_2026-08-16_12-31-50.mat';
input_data = load(input_file);
time_series_data = input_data.time_series;
clear input_data;
disp('Movie Desikan data loaded successfully.');
...
output_file = fullfile(output_path, ['vDFC_results_MD_W3_107_' num2str(time) '.mat']);
