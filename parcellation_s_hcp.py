...
time_series_file_hcp = os.path.join(out_dir, "TS_smt_HCP_{}.npy".format(timestamp))
...
if len(unique_shapes) == 1:
	...
	scipy.io.savemat(mat_file_hcp, mdict={'TS_smt_HCP': time_series_all_np, 'subject_ids': subject_ids_mat}) # export as mat file
...
subject_ids_file = os.path.join(out_dir, "subID_rst_HCP_{}.csv".format(timestamp))
...
if error_files:
	...
	error_file = os.path.join(out_dir, "error_subID_smt_HCP_{}.csv".format(timestamp))
