...
time_series_file_desikan = os.path.join(out_dir, "time_series_movie_desikan_all_denoised_{}.npy".format(timestamp))
...
# subject_ids_file = os.path.join(out_dir, "subject_ids_movie_desikan_all_denoised_{}.csv".format(timestamp))
...
if error_files:
	...
	error_file = os.path.join(out_dir, "error_subjects_movie_desikan_all_denoised_{}.csv".format(timestamp))
